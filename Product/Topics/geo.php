...
<body>
    ...
    <div class="logoutc"><a href="../Log in/public/logout.php" class="logout">Log out</a></div>
        ...
        <section class="lecture">
                    <section class="docu1"> 
                    <iframe src="https://docs.google.com/document/d/e/2PACX-1vT7SgPKvUjYDTM3gTovmo-02HFjJX91DTI2hK524bHQNIngVnwpFcHGDODXWtwkeg/pub?embedded=true"></iframe>
                    </section>
                    <section class="docu2">
                    <iframe src="https://docs.google.com/document/d/e/2PACX-1vT_nkLEnsz3rCyO0UcCu5k8it_RRPNokJ_-X-51j3wJqpQcugCwNfaqfkpwy780MQ/pub?embedded=true"></iframe>
                    </section>
                </section>
