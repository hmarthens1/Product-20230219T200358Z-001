...
<body>
    ...
    <div class="logoutc"><a href="../Log in/public/logout.php" class="logout">Log out</a></div>
        ...
        <section class="lecture">
                    <section class="docu1"> 
                        <iframe src="https://docs.google.com/document/d/e/2PACX-1vQZ2MCO-fr5kKZl0rL8TvybVQfWrxWM39ZelcTPUE001narxgYRyLmKdeaE_6gzLw/pub?embedded=true"></iframe>
                    </section>
                    <section class="docu2">
                    <iframe src="https://docs.google.com/document/d/e/2PACX-1vTGT2_xG1LrwyBX_1PK6S8v-7cML1r8dcwsGoydF6cI8O9vkoRpuhYD2iwjMzP0wA/pub?embedded=true"></iframe>
                    </section>
                </section>
